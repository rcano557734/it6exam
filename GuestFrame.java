...
public class GuestFrame extends javax.swing.JFrame {
    ...
    try {
        ...
        ResultSet rs = st.executeQuery("SELECT * FROM guest_tbl");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        ...
                                        .addComponent(jButton2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String query="INSERT INTO guest_tbl(fname,lname) VALUES ('"+t2.getText()+"','"+t3.getText()+"')";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String query = "update guest_tbl set fname='"+t2.getText()+"',lname='"+t3.getText()+"' where guest_ID='"+t1.getText()+"'";
        sql.executeSQLQuery(query,"Updated");
        loadGuestTable();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String query="DELETE FROM guest_tbl WHERE guest_id='"+t1.getText()+"'";
