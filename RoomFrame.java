...
public class RoomFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "INSERT INTO Rooms_Tbl(room_type, price) VALUES ('" + selectedRoomType + "','" + t3.getText() + "')";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String selectedRoomType = combo.getSelectedItem().toString();
        String query = "UPDATE Rooms_Tbl SET room_type='" + selectedRoomType + "', price='" + t3.getText() + "' WHERE room_id='" + t1.getText() + "'";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String query = "DELETE FROM Rooms_Tbl WHERE room_id='" + t1.getText() + "'";
