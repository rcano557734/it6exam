...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 22, 2026 at 09:26 AM
...
INSERT INTO `rooms_tbl` (`room_id`, `room_type`, `price`) VALUES
(1, 'Regular', 500),
(2, 'Regular', 600);
...
--
ALTER TABLE `reservation_tbl`
  ADD CONSTRAINT `reservation_tbl_ibfk_1` FOREIGN KEY (`guest_id`) REFERENCES `guests_tbl` (`guest_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `reservation_tbl_ibfk_2` FOREIGN KEY (`room_id`) REFERENCES `rooms_tbl` (`room_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
